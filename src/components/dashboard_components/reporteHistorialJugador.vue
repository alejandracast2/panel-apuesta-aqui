        ...
        <main :class="view_type">
                    ...
                    <div class="col-md-12 p-0">
                        <div class="row mt-4 mb-3">
                            <div class="col-6 col-lg-9 pt-2 pl-4">
                                <h5 class="white-text font-weight-bold">Historial de Jugador</h5>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="card-body p-1 py-4 px-sm-4">
                                        <div class="row mx-2">
                                            <div
                                                ...
                                                <div class="md-form">
                                                    <customCalendar class="form-control" :reference="1"
                                                        :date="startDate" id="start_date"
                                                        @updateData="event => startDate = event"
                                            ...
                                            <div
                                                ...
                                                <div class="md-form">
                                                    <customCalendar class="form-control" :reference="2" :date="endDate"
                                                        id="start_date" @updateData="event => endDate = event"
                                                        style="border-color: transparent;" />
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th scope="col"
                                                            ...
                                                            rowspan="1" colspan="1" style="width: 167px;">Saldo
                                                            Posterior
                                                        </th>
                                                    </tr>
                                                </thead>
            ...
            parseNumbers(item.valor) }}</td>
                                                        ...
                                                        <td class="dt-after d-none d-lg-table-cell pr-sm-3 text-right">
                                                            {{ parseNumbers(item.nuevo_capital) }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
    ...
    methods: {
        ...
        async getReport() {
            try {
                ...
                let response =
                    await axios.post(this.apiUrlnew + "historial_jugador", {
